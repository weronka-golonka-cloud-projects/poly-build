...
class BuildingSitesRepositoryTest : DescribeSpec({
    ...
    val testBuildingSite = BuildingSites(
        id = testId,
        buildingLimits = "test",
        heightPlateaus = "test",
    ...
    beforeEach {
        ...
        dynamoDbProvider = DynamoDbClientProvider(
    ...
    describe("update") {
        val newBuildingSite = BuildingSites(
            id = testId,
